<?php
/**
 * Product news featured post item template for Inventor Post Grid/Slider.
 *
 * Expected variables:
 * - int    $post_id
 * - string $permalink
...
$item_template_class = isset( $item_template_class ) ? (string) $item_template_class : 'inventor-post-item-product-news-featured';
$summary_length      = ! empty( $settings['excerpt_length'] ) ? absint( $settings['excerpt_length'] ) : 24;
